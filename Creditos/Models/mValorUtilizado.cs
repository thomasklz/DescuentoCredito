...
namespace Creditos.Models
{
    public class mValorUtilizado{
        ...
        public mValorUtilizado(int id_valor_usad, int valor_asig_id, string persona, string proveedor, string mes, double cantidad_usada){
            this.id_valor_usad = id_valor_usad;
            this.valor_asig_id = valor_asig_id;
        ...
        public mValorUtilizado(int id_valor_usad, string aso, string persona, string mes, double cantidad_aprobada, double cantidad_usada){
            this.id_valor_usad = id_valor_usad;
            this.aso = aso;
            this.persona = persona;
            this.mes = mes;
