...
namespace Creditos.Entity
{
    ...
    public partial class NivelOcupacional
    {
        ...
        {
            this.EscalaOcupacional = new HashSet<EscalaOcupacional>();
        }
    
        public int NivelOcupacionalId { get; set; }
        public string Descripcion { get; set; }
        public Nullable<int> TipoRegimenId { get; set; }
        public Nullable<bool> Eliminado { get; set; }
    
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA2227:CollectionPropertiesShouldBeReadOnly")]
        public virtual ICollection<EscalaOcupacional> EscalaOcupacional { get; set; }
