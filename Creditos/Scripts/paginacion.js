...
(function (za, O, l) {
    var N = function (h) {
        ...
        a.aoColumns[c].fnSetData(a.aoData[b]._aData,
            ...
            var b = a.oClasses, c = a.sTableId, d = a.oLanguage, e = a.oPreviousSearch, f = a.aanFeatures, g = '<div class="kt-input-icon kt-input-icon--left"><input type="text" class="form-control filtrar" id="filtrar"><span class="kt-input-icon__icon kt-input-icon__icon--left"><span><i class="la la-search"></i></span></span></div> ', j = d.sSearch, j = j.match(/_INPUT_/) ? j.replace("_INPUT_", g) : j + g, b = h("<div/>",
        ...
        r("clear()", function () { return this.iterator("table", function (a) { ja(a) }) }); r("settings()", function () { return new q(this.context, this.context) }); r("data()", function () { return this.iterator("table", function (a) { return C(a.aoData, "_aData") }).flatten() }); r("destroy()", function (a) {
            ...
            []; p.models = {}; p.models.oSearch = { bCaseInsensitive: !0, sSearch: "", bRegex: !1, bSmart: !0 }; p.models.oRow = { nTr: null, anCells: null, _aData: [], _aSortData: null, _aFilterData: null, _sFilterRow: null, _sRowStripe: "", src: null }; p.models.oColumn = {
                ...
                aaData: null, aaSorting: [[0, "asc"]], aaSortingFixed: [], ajax: null, aLengthMenu: [5, 10, 15, 20], aoColumns: null, aoColumnDefs: null, aoSearchCols: [], asStripeClasses: null, bAutoWidth: !0, bDeferRender: !1, bDestroy: !1, bFilter: !0, bInfo: !0, bJQueryUI: !1, bLengthChange: !0, bPaginate: !0, bProcessing: !1, bRetrieve: !1, bScrollCollapse: !1, bServerSide: !1, bSort: !0, bSortMulti: !0, bSortCellsTop: !1, bSortClasses: !0, bStateSave: !1,
                ...
                fnStateLoaded: null, fnStateSaveCallback: function (a, b) { try { (-1 === a.iStateDuration ? sessionStorage : localStorage).setItem("DataTables_" + a.sInstance + "_" + location.pathname, JSON.stringify(b)) } catch (c) { } }, fnStateSaveParams: null, iStateDuration: 7200, iDeferLoading: null, iDisplayLength: 5, iDisplayStart: 0, iTabIndex: 0, oClasses: {}, oLanguage: {
                    ...
                    sEmptyTable: "No existen datos actualmente en la tabla", sInfo: "Mostrando _START_ a _END_ - _TOTAL_ Totales", sInfoEmpty: "Mostrando 0 a 0 - 0 Totales", sInfoFiltered: "(diltrado desde _MAX_ total registros)", sInfoPostFix: "", sDecimal: "", sThousands: ",", sLengthMenu: "Mostrando _MENU_ entradas", sLoadingRecords: "Loading...", sProcessing: "Processing...", sSearch: "</br> ", sSearchPlaceholder: "Search...", sUrl: "", sZeroRecords: "No se ha encontrado ningun registro"
                ...
                fnServerData: null, aoServerParams: [], sServerMethod: null, fnFormatNumber: null, aLengthMenu: null, iDraw: 0, bDrawing: !1, iDrawError: -1, _iDisplayLength: 5, _iDisplayStart: 0, _iRecordsTotal: 0, _iRecordsDisplay: 0, bJUI: null, oClasses: {}, bFiltered: !1, bSorted: !1, bSortCellsTop: null, oInit: null, aoDestroyCallback: [], fnRecordsTotal: function () { return "ssp" == z(this) ? 1 * this._iRecordsTotal : this.aiDisplayMaster.length }, fnRecordsDisplay: function () { return "ssp" == z(this) ? 1 * this._iRecordsDisplay : this.aiDisplay.length }, fnDisplayEnd: function () {
                    var a =
                        ...
                        var g = a.oClasses, j = a.oLanguage.oPaginate, i, l, m = 0, o = function (b, d) {
                            var k, p, r, q, s = function (b) { Ra(a, b.data.action, true) }; k = 0; for (p = d.length; k < p; k++) {
                                q = d[k]; if (h.isArray(q)) { r = h("<" + (q.DT_el || "div") + "/>").appendTo(b); o(r, q) } else {
                                    ...
                                    }if (i) { r = h("<a>", { "class": g.sPageButton + " " + l, "aria-controls": a.sTableId, "data-dt-idx": m, tabindex: a.iTabIndex, id: c === 0 && typeof q === "string" ? a.sTableId + "_" + q : null }).html('<a type="button" class="btn btn-default" title=Seleccionar>'+i+'</a>' +' - ').appendTo(b); Ta(r, { action: q }, s); m++ }
                                }
                            }
